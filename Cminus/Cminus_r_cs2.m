//We compute the cluster picture and conductor of the curve Crrp at r when r nmid ab
...
print "Cminus(r, p, a, c) at r when r does not divide a*b and gminus is reducible.";
print "###########################################################################\n\n";
