...
//and the polynomial gminus is reducible over Qr.
...
function Cplus_r_cs1(r, p, rge, counter);
    Qr := pAdicField(r, 200);
...
print "Cplus(r, p, a, c) at r when r does not divide a*b and gminus is reducible.";
print "#############################################################################\n\n";
...
res_5_7 := Cplus_r_cs1(5, 7, 5000, 10);

print "\n\n#########################################";
print "Computing 10 iterations for r = 5, p = 11";
print "#########################################\n\n";

res_5_11 := Cplus_r_cs1(5, 11, 5000, 10);

print "\n\n########################################";
print "Computing 10 iterations for r = 7, p = 5";
print "########################################\n\n";

res_7_5 := Cplus_r_cs1(7, 5, 5000, 10);

print "\n\n#########################################";
print "Computing 10 iterations for r = 7, p = 11";
print "#########################################\n\n";

res_7_11 := Cplus_r_cs1(7, 11, 5000, 10);
